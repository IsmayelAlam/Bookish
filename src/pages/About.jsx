      ...
      <div className="text-grayish01 w-fit px-2">
        ...
        <div className="space-y-2 text-sm sm:text-base">
          ...
          <p>
            ...
            skills for others. I did the front end part only and get the
            database from OpenLibrary, the best free api for book, with over 30
          ...
          <p>
            OpenLibrary is great but there is some inconsistently in the
            database. So some books don&apos;t show all details.
          </p>
          <p>
