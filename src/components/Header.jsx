...
export default function Header({ styleClass }) {
  return (
    <div className="sm:py-5">
      <div
        className={`flex sm:mx-auto sm:w-10/12 sm:rounded-full w-full sm:px-10 text-sm sm:text-md sm:border-2 px-5 py-2 justify-between items-center bg-bg02 border-border01 ${styleClass}`}
      >
        <Link to="/">
          <Logo />
        </Link>
